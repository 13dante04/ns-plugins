import { MapView, Position, Marker, Shape, Polyline, Polygon, Projection, Circle, Camera, MarkerEventData, ShapeEventData, VisibleRegion, CameraEventData, PositionEventData, Bounds, MapStyle, IndoorBuilding, IndoorLevel, IndoorLevelActivatedEventData, BuildingFocusedEventData } from '.';
...
export abstract class MapViewBase extends View implements MapView {
	...
	public abstract settings: UISettingsBase;
	public abstract myLocationEnabled: boolean;
	...
	public abstract setupMarkerCluster(markers: Marker[], clusterMinNumber: number);

	public abstract findShape(callback: (shape: Shape) => boolean): Shape;

	public abstract setStyle(style: MapStyle): boolean;
	...
	public abstract pushMarker(...markers: Marker[]): void;
...
export abstract class ProjectionBase implements Projection {
	public abstract visibleRegion: VisibleRegion;
	public abstract fromScreenLocation(point: Point): Position;
	public abstract toScreenLocation(position: Position): Point;
	public abstract ios: any; /* GMSProjection */
	public abstract android: any;
}

export abstract class VisibleRegionBase implements VisibleRegion {
	public abstract nearLeft: Position;
	public abstract nearRight: Position;
	public abstract farLeft: Position;
	public abstract farRight: Position;
	public abstract bounds: Bounds;
}

export abstract class PositionBase implements Position {
	public abstract latitude: number;
	public abstract longitude: number;
	public abstract ios: any; /* CLLocationCoordinate2D */
	public abstract android: any;
}

export abstract class BoundsBase implements Bounds {
	public abstract northeast: Position;
	public abstract southwest: Position;
	public abstract ios: any; /* GMSCoordinateBounds */
	public abstract android: any;
}
...
export abstract class MarkerBase implements Marker {
	...
	public abstract anchor: Array<number>;
	public abstract title: string;
	public abstract snippet: string;
	public abstract color: Color | string | number;
	public abstract icon: Image | string;
	public abstract alpha: number;
	public abstract flat: boolean;
	public abstract draggable: boolean;
	...
	public userData: any;
	public _map: any;
	public abstract ios: any;
	public abstract android: any;
}

export abstract class ShapeBase implements Shape {
	public abstract shape: string;
	public abstract visible: boolean;
	public abstract zIndex: number;
	public userData: any;
	public _map: any;
	public abstract ios: any;
	public abstract android: any;
	public abstract clickable: boolean;
}
...
export abstract class PolylineBase extends ShapeBase implements Polyline {
	...
	public abstract geodesic: boolean;
...
export abstract class PolygonBase extends ShapeBase implements Polygon {
	...
	public abstract strokeWidth: number;
	public abstract strokeColor: Color;
	public abstract fillColor: Color;
