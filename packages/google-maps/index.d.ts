...
export class MapView extends View {
	...
	/**
	 *
	 * @param markers array of markers to form a cluster
	 * @param clusterMinNumber minimum number of items that should form a cluster
	 */
	public setupMarkerCluster(markers: Marker[], clusterMinNumber: number): void;
	 ...
	 * ios: GMSMapView
	 *
	 * android: com.google.android.gms.maps.MapView */
	...
	public pushMarker(...markers: Marker[]): void;
	...
	public setStyle(style: MapStyle): boolean;
}
...
export class UISettings {
	...
	/**
	 * Whether the mapToolbarEnabled level picker is enabled/disabled.
	 */
	mapToolbarEnabled: boolean;
	/**
	 * Whether the myLocationButtonEnabled level picker is enabled/disabled.
	 */
	myLocationButtonEnabled: boolean;
	/**
	 * Whether the rotateGesturesEnabled level picker is enabled/disabled.
	 */
	rotateGesturesEnabled: boolean;
	/**
	 * Whether the scrollGesturesEnabled level picker is enabled/disabled.
	 */
	scrollGesturesEnabled: boolean;
	/**
	 * Whether the tiltGesturesEnabled level picker is enabled/disabled.
	 */
	tiltGesturesEnabled: boolean;
	/**
	 * Whether the zoomControlsEnabled level picker is enabled/disabled.
	 */
	zoomControlsEnabled: boolean;
	/**
	 * Whether the zoomGesturesEnabled level picker is enabled/disabled.
	 */
...
export class Marker {
	...
	/**
	 * Default Icon color - either Color, string color name, string color hex, or number hue (0-360)
	 */
...
export class MapStyle extends Array<StyleElement> {
	public center: Position;
	public radius: number;
	public strokeWidth: number;
	public strokeColor: Color;
...
export type StyleElementType =
	...
	| 'administrative.neighborhoodadministrative.province'
	| 'landscape'
	| 'landscape.man_made'
	| 'landscape.natural'
...
export type StyleFeatureType = 'all' | 'geometry' | 'geometry.fill' | 'geometry.stroke' | 'labels' | 'labels.icon' | 'labels.text' | 'labels.text.fill' | 'labels.text.stroke';
